...
class BookRow extends Component {
    ...
    render() {
        const { audiobook, author, categories, coverImg, genresList, genre, inProgress, summary, title } = this.props;
        const { bookIsClicked } = this.state;

        return (
            <div role="button" tabIndex={0} className={classNames("BookRow__container", {'BookRow__container--expanded' : bookIsClicked})} onKeyPress={this.openBook} onClick={this.openBook}>
                ...
                <div role="button" tabIndex={0} className={classNames("BookRowSummary__container", { 'BookRowSummary__container--expanded': bookIsClicked })} onKeyPress={this.openBook} onClick={this.openBook}>
